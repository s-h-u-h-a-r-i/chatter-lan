 ...
 *
 * A functional error-handling type inspired by Rust's Result type.
 * Provides a type-safe way to represent operations that can either success (Ok) or fail (Err).
 * eliminating the need for throwing exceptions and enabling functional composition.
 *
 * @example
 *
 * // Basic usage
 ...
 * const recovered = errorResult.unwrapOr(0); // 0
 *
 * // Async operations
